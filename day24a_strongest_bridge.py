...
def find_strongest_bridge(piece_map, bridge = [0]):
    ...
    for piece in available_pieces:
        ...
        result_bridge = find_strongest_bridge(piece_map, new_bridge)

        if sum(result_bridge) > sum(result):
...
def main(lines):
    ...
    bridge = find_strongest_bridge(piece_map)
